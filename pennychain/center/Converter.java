...
public class Converter {
    ...
    public static void displayCurrencyConverter()
    {
        ...
        Scanner user_totalAmountToBeConverted = new Scanner(System.in);
        int user_choice = user_totalAmountToBeConverted.nextInt();
        ...
        int desiredCurrency = user_totalAmountToBeConverted.nextInt();

        System.out.printf("Please enter the amount of money you want to convert in " + currentCurrency);
        double totalAmountToBeConverted = user_totalAmountToBeConverted.nextDouble();

        if (user_choice == desiredCurrency)
            System.out.println("These are the same currencies. No need to convert!");

        if (user_choice == 1 && desiredCurrency == 3)
        {
        ...
        else if (user_choice == 1 && desiredCurrency == 2){
        ...
        else if (user_choice == 1 && desiredCurrency == 4){
        ...
        if (user_choice == 3 && desiredCurrency == 1)
        {
        ...
        else if (user_choice == 3 && desiredCurrency == 2)
        {
        ...
        else if (user_choice == 3 && desiredCurrency == 4)
        {
        ...
        if (user_choice == 2 && desiredCurrency == 1)
        {
        ...
        else if (user_choice == 2 && desiredCurrency == 3)
        {
        ...
        else if (user_choice == 2 && desiredCurrency == 4)
        {
        ...
        if (user_choice == 4 && desiredCurrency == 1)
        {
        ...
        else if (user_choice == 4 && desiredCurrency == 3)
        {
        ...
        else if (user_choice == 4 && desiredCurrency == 2)
        {
